...
class ObjectLocations:
    ...
    def save_to_json(self, file_path: str = JSON_OUTPUT_FILE) -> None:
      
        print(
            f"Saving objects for image '{self.associated_image}' to {file_path}")
        ...
        if os.path.exists(file_path):
            ...
            if not image_found:
                existing_data.append(
                    {'image_name': self.associated_image, 'objects': self.objects})
